    ...
    <div class="desktop:max-w-full desktop-above:max-w-[1440px] desktop-above:my-0 desktop-above:mx-auto h-[92vh] overflow-hidde">
        <header class="x-pad py-12 h-[17%]">
            <nav class="flex justify-between items-center">
                ...
                <div>
                    <NuxtLink target="_blank" to="mailto:usedingpay@gmail.com" class="phablet:hidden text-black text-base font-medium" :class="{'text-white': !isTabPersonal}" >Contact us</NuxtLink>
                </div>
            </nav>
        </header>
